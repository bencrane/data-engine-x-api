...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://staffingactivation.com",
        "https://www.staffingactivation.com",
        "https://app.staffingactivation.com",
    ] + [f"http://localhost:{p}" for p in range(3000, 3011)],
    allow_origin_regex=r"https://([a-zA-Z0-9-]+\.)?outboundsolutions\.com",
